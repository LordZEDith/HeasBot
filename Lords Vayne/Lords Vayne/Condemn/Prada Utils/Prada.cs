...
namespace Lords_Vayne.Condemn.Prada_Utils
{
    public static class Extensions
    {
        ...
        public static Vector3 GetTumblePos(this Obj_AI_Base target)
        {
            ...
            var aRC = new Lords_Vayne.Condemn.Prada_Utils.Geometry.Circle(Heroes.Player.ServerPosition.To2D(), 300).ToPolygon().ToClipperPath();
