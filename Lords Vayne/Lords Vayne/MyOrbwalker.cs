  ...
  /* static class MyOrbwalker
    {
        ...
        public class Orbwalker : IDisposable
        {
            ...
            public Orbwalker(Menu attachToMenu)
            {
                ...
                /* Drawings submenu */
                /*var drawings = new Menu.AddSubMenu("Drawings", "drawings");
                drawings.Add(
                    new MenuCheckBox("AACircle", "AACircle").SetShared()
                        ...
                        if (minions.Any())
                        {
                            ...
                            var turretMinion =
                                minions.FirstOrDefault(
                                    minion =>
                                    minion is Obj_AI_Minion && MinionHealthPrediction.HasTurretAggro(minion as Obj_AI_Minion));
            ...
            private void DrawingOnOnDraw(EventArgs args)
            {
                ...
                if (_config.Item("LastHitHelper").GetValue<bool>())
                {
                                ...
                                x => x.Name.ToLower().Contains("minion") && x.IsHPBarRendered && x.IsValidTarget(1000)))
                    {
                        ...
                        {
                           Circle.DrawCircle(minion.Position, 50, Color.LimeGreen);
                        }
                    }
                }
            }
